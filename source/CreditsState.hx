...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Cara q fez o port'],
			['Marcelo gamer ofical',	'marcelo',				'shyrxZ e gay lol',					'https://youtube.com/channel/UCXNiQ0ba5hDu31NsEjZC15w', 	'0CCEF5'],
			['Guislakkkk',	'gui',				'ajudou no menu lol',					'https://youtube.com/channel/UCVniqkS8csFDi8U2N6UrVhQ', 	'FE0015'],
			[''],
			['Psych Engine Team'],
